//
//  CouchSearchAdvanceFormVariant.m
//  CouchSourfing
//
...
@interface CouchSearchAdvancedFormVariant ()
@property (nonatomic, retain) NSArray *items;
@end


@implementation CouchSearchAdvancedFormVariant
...
- (id)init {
    if (self = [super init]) {
        self.items = [NSArray arrayWithObjects:
                      ...
                      //added
                      NSLocalizedString(@"Wheelchair accessible", @"form label"),
                      NSLocalizedString(@"Verification Level", @"form label"),
                      NSLocalizedString(@"Vouched", @"form label"),
                      NSLocalizedString(@"Ambassadors only", @"form label"),
                      NSLocalizedString(@"Name", @"form label"),
                      
                      NSLocalizedString(@"Keywords", @"form label"),
                      
                      //added
                      NSLocalizedString(@"Language", @"form label"),
                      NSLocalizedString(@"Gender", @"form label"),
                      NSLocalizedString(@"Has picture", @"form label"),
                      NSLocalizedString(@"Minimum Age", @"form label"),
                      NSLocalizedString(@"Maximum Age", @"form label"),
                      NSLocalizedString(@"Last Login", @"form label"),
                      NSLocalizedString(@"Results per page", @"form label"),
                      NSLocalizedString(@"Order by", @"form label"),
...
- (NSString *)name {
    return NSLocalizedString(@"Advanced", @"Advanced search form variant");
}
...
- (NSArray *)rowsToInsertFrom:(id <CouchSearchFormVariant>)fromVariant {
    if ([[fromVariant name] isEqualToString:@"Basic"]) {
